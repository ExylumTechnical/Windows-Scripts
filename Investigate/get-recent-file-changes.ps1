# this should only be used on external drives, can be time intensive if there are a lot of file changes
# or large number of files on the specified drive

param (
    # Default to the D external drive
